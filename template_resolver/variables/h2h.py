...
def extract_rematch_date(ctx: TemplateContext, game_ctx: GameContext | None) -> str:
    if not game_ctx or not game_ctx.h2h:
        return ""
    return game_ctx.h2h.previous_date or ""
...
def extract_rematch_score_abbrev(
    ...
    if not game_ctx or not game_ctx.h2h or not game_ctx.h2h.previous_score_abbrev:
        return ""
    return game_ctx.h2h.previous_score_abbrev
